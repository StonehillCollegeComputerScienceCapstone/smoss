...
import unittest
import sys
from TriangleUnitTestExample.Trianglempeters import Triangle
...
class TestTriangleMethods(unittest.TestCase):
    ...
    def testDecimal(self):
        t = Triangle()
        self.assertFalse(t.isValid(.4, 1.8, 23.7))

    def testTooBigOfInt(self):
        t = Triangle()
        self.assertFalse(t.isValid(1,1,sys.maxint))

    def testNearTooBigOfInt(self):
        t = Triangle()
        self.assertTrue(t.isValid(1,5,sys.maxint-1))
